%This script will demostrate the function to calculate coverages

function [coverage_values_1, coverage_values_2, coverage_values_3] = draw_line_graph(d,L,n, r, B1, C1,L1,Lr)
...
%     L1 = -L0_C3; %select a vlaue for L1
    ...
    elseif L1 < 0
        ...
        if strcmp(str1, 'caseA')||strcmp(str1, 'caseB')%---------------caseA
            Overlap_C3 = (-L1/2)*tan(C1+B1/2)*(-L1);
        elseif strcmp(str1, 'caseC')%----------------------------------caseC
            Overlap_C3 = 0;
        elseif strcmp(str1, 'caseD')||strcmp(str1, 'caseE')||strcmp(str1, 'caseF')%----caseD
            angle1 = pi - C1 + B1/2;
            angle2 = pi - C1 - B1/2;
            h = (-L1/2)*tan(C1+B1/2);
            h1 = (-L1/2)*tan(C1-B1/2);
